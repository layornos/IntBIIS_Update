...
/**
 * This class probe's the entry time of actor steps.
 * @author Nesta Bentum
 *
 * @param <E> The type that is probed.
 */
@Probe(type = AbstractUserAction.class, property = "before")
public class ActorStepEntryProbe<E extends AbstractUserAction> extends AbstractProbe<E, WorkloadMeasurementConfiguration> {

	public ActorStepEntryProbe(MeasuringPoint<E> p, WorkloadMeasurementConfiguration cfg) {
		super(p, cfg);
