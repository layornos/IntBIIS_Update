...
@Probe(type = SimDeviceResource.class, property = "request_time")
public class SimDeviceRequestedProbe extends AbstractProbe<SimDeviceResource, SimDeviceResourceProbeConfiguration>{

	public SimDeviceRequestedProbe(MeasuringPoint<SimDeviceResource> p,
