...
/**
 * This class probe's the exit time of activities.
 * @author Nesta Bentum
 *
 * @param <E> The type that is probed.
 */
@Probe(type = AbstractUserAction.class, property = "after")
public class ActivityExitTimeProbe<E extends AbstractUserAction> extends AbstractProbe<E, WorkloadMeasurementConfiguration>  {

	public ActivityExitTimeProbe(MeasuringPoint<E> p, WorkloadMeasurementConfiguration cfg) {
		super(p, cfg);
