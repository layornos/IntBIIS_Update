...
/**
 * This class probe's the entry time of activities.
 * @author Nesta Bentum
 *
 * @param <E> The type that is probed.
 */
@Probe(type = AbstractUserAction.class, property = "before")
public class ActivityEntryTimeProbe <E extends AbstractUserAction> extends AbstractProbe<E, WorkloadMeasurementConfiguration> {

	public ActivityEntryTimeProbe(MeasuringPoint<E> p, WorkloadMeasurementConfiguration cfg) {
		super(p, cfg);
